...
const experiences: ExperienceItem[] = [
  {
    ...
    moreTech: ["JavaScript", "NoCode/LowCode", "CI/CD", "Git", "Docker", "Redis", "Celery", "REST API", "GitHub Actions"],
    logo: timberbaseLogo,
  ...
  },
  {
    ...
    moreTech: ["JS/TS", "Expo", "WebSockets", "REST API", "Git", "Docker", "Fastlane", "Jest", "Push Notifications", "Gradle"],
    logo: uberblickLogo,
